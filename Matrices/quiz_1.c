...
main(){
    ...
    int M[10][10],V1[10],V1_1[10],V1_2[10],V2[10],V2_1[10],V2_2[10];
    int c1=0,c2=0;
    ...
    if (c1>c2){
        prom=s1/c1;
        printf ("\nEn la matriz hay más valores positivos múltiplos de cinco. En total hay %d. Estos son en estas posiciones:\n",c1);
        for (i=1;i<=c1;i++){
        printf ("\n%d --> [%d,%d]\n",V1[i],V1_1[i],V1_2[i]);}
    ...
    if (c2>c1){
        prom2=s2/c2;
        printf ("\nEn la matriz hay más valores negativos múltiplos de cinco. En total hay %d. Estos son en estas posiciones:\n",c2);
        for (i=1;i<=c2;i++){
        printf ("\n%d --> [%d,%d]\n",V2[i],V2_1[i],V2_2[i]);}
